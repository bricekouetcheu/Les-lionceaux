# Generated by Django 3.2 on 2021-07-13 20:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_add', models.DateTimeField(auto_now_add=True)),
                ('date_upd', models.DateTimeField(auto_now=True)),
                ('groupe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='groupe_enfant', to='utilisateurs.groupe')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parent_enfant', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Enfant',
